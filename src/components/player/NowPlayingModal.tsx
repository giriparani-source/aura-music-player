...
export const NowPlayingModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-[#07090e]/95 backdrop-blur-3xl flex flex-col p-4 sm:p-6 select-none overflow-y-auto overflow-x-hidden animate-in fade-in duration-200">
      ...
      {/* Main Content Area: Switches by activeModalTab */}
      <div className="py-6 flex-1 flex flex-col items-center justify-center max-w-5xl mx-auto w-full min-h-0">
        ...
        {activeModalTab === 'ai-insights' && (
          <div className="w-full h-80 sm:h-96 flex flex-col max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="p-3 rounded-full text-neutral-300 hover:text-white transition-colors"
              title="Previous"
            >
              <SkipBack size={24} />
            </button>
            ...
            <button
              onClick={togglePlay}
              className="w-16 h-16 rounded-full bg-white text-black flex items-center justify-center hover:scale-105 active:scale-95 transition-all shadow-xl shadow-white/20 cursor-pointer"
              title="Play / Pause"
            >
